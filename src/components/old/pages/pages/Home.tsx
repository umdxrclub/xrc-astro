...
import XRCConstants from '../XR_CONSTANTS';
        ...
        <div id="Home">
            ...
            <div id="home-about" className="section">
                ...
                <div className="vertical-flexbox-container">
                    <h2>MISSION</h2>
                    <ReactMarkdown children={XRCConstants.HOME_PAGE.MISSION} linkTarget="_blank"></ReactMarkdown>
            ...
            <div id="home-events" className="section">
                ...
                <div className="padding-small horizontal-flex-container flex-even">
                    {
                        XRCConstants.HOME_PAGE.HOME_ACTION_CARDS.map(action_card => {
                            return <HomeActionCard id={XRCConstants.HOME_PAGE.HOME_ACTION_CARDS.indexOf(action_card)}
